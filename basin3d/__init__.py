...
| `/synthesis/models --` Returns a list of models.
| `/synthesis/models/:id --` Get a single model
...
| `/synthesis/models_domains --` Returns a list of model domains.
| `/synthesis/models_domains/:id --` Get a single model domain.
| `/synthesis/regions/:region_id/model_domains --` Get all of the model domains for a region.

**Attributes:**
    - *id:* string
    - *name:* string
    - *geom:* a custom geometry

**URLs**
  + url -- for detail on a model domain
  + meshes -- get all of the model domain meshes
...
| `/synthesis/meshes/:id --` Get a single mesh
| `/synthesis/model_domains/:model_domain_id/meshes --` Get the meshes for a model domain
...
**Attributes:**
    ...
    - *geom:* a custom geomeory


**URLs**
  + url -- for detail on a single mesh
...
**URLs**
  + url -- for detail on a single model run
